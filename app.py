...
if client:
    ...
    with st.expander("Demo Datasets"):
        ...
        demo_datasets = [
            {"name": "Wine reviews", "description": "Wine reviews from [Kaggle](https://www.kaggle.com/datasets/zynicide/wine-reviews) containing 150k reviews.", "callback": import_csv_data, "args": [client, "data/winemag-data-130k-v2.csv", "WineReview", demo_max_objs], "disabled": True},
